...
public class WebDriverFactory {
    ...
    public static synchronized WebDriver newWebdriverInstance(FluentCucumberTest adapter, SupportedWebDriver driverType, DesiredCapabilities capabilities) throws UnsupportedDriverException {
